...
# Функция any работает аналогично all. Но если all можно представить как if c цепочкой and,
# то any — это if с цепочкой or. Функция map заменила числа на True и False, далее all проверила все ли элементы

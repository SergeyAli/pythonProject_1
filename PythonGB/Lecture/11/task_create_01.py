...
За создание экземпляра класса отвечает дандер метод __init__. С ним вы уже знакомы по прошлому занятию. Всё дело в том,
что это самый частый дандер метод в ООП Python
'''

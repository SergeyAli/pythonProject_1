...
Как вы помните ключом dict и элементами set и frozenset могут быть только неизменяемые типы данных. А для проверки
на неизменяемость используется функция hash(). Она должна возвращать целое число в 4 или 8 байт в зависимости от
разрядности интерпретатора Python. И это число должно быть неизменным на всём протяжении работы программы.

...
В каталогах можно хранить другие каталоги и файлы. В файлах содержатся данные. А символьные ссылки указывают на
каталоги и файлы из других мест. Рассмотрим варианты получения информации об объектах, полученных в примере кода выше.
'''
